      ...
      <div className="relative min-h-[90vh] sm:min-h-[70vh] bg-zinc-50 pb-12 sm:pb-24">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="pt-16 sm:pt-24 pb-8 sm:pb-12 max-w-4xl">
            <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-sm px-3 sm:px-4 py-2 rounded-full mb-6">
              <span className="w-2 h-2 bg-emerald-400 rounded-full"></span>
              <span className="text-white text-sm sm:text-base font-medium">South Yorkshire Skills Hub</span>
            </div>
...
Career Pathways                  <ChevronRight className="ml-2 h-5 w-5" />
          ...
          <div className="grid gap-3 sm:gap-6 md:grid-cols-2 lg:grid-cols-3 mb-8 sm:mb-12">
            {/* Educators Card */}
            <Link href="/educators" className="group relative bg-white rounded-xl overflow-hidden shadow-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
              ...
              <div className="relative z-10 p-4 sm:p-8">
                <div className="flex items-center gap-4 mb-3 sm:mb-6">
                  ...
                  <h3 className="text-lg sm:text-2xl font-bold text-zinc-900 group-hover:text-white transition-colors">For Schools & Colleges</h3>
                </div>
                ...
                <div className="flex items-center text-emerald-600 group-hover:text-white transition-colors">
                  <span className="text-sm sm:text-base font-medium">View resources</span>
            ...
            <Link href="/business" className="group relative bg-white rounded-xl overflow-hidden shadow-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
              ...
              <div className="relative z-10 p-4 sm:p-8">
                <div className="flex items-center gap-4 mb-3 sm:mb-6">
                  ...
                  <h3 className="text-lg sm:text-2xl font-bold text-zinc-900 group-hover:text-white transition-colors">For Employers</h3>
                </div>
                <p className="text-sm sm:text-lg text-zinc-600 group-hover:text-white/90 transition-colors mb-3 sm:mb-6 line-clamp-2 sm:line-clamp-none">
                ...
                <div className="flex items-center text-blue-600 group-hover:text-white transition-colors">
                  <span className="text-sm sm:text-base font-medium">Get support</span>
                  <ChevronRight className="ml-2 h-4 w-4 sm:h-5 sm:w-5" />
                </div>
              </div>
            </Link>
            ...
            <Link href="/young-people" className="group relative bg-white rounded-xl overflow-hidden shadow-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
              ...
              <div className="relative z-10 p-4 sm:p-8">
                <div className="flex items-center gap-4 mb-3 sm:mb-6">
                  ...
                  <h3 className="text-lg sm:text-2xl font-bold text-zinc-900 group-hover:text-white transition-colors">For Young People</h3>
                </div>
                <p className="text-sm sm:text-lg text-zinc-600 group-hover:text-white/90 transition-colors mb-3 sm:mb-6 line-clamp-2 sm:line-clamp-none">
                ...
                <div className="flex items-center text-purple-600 group-hover:text-white transition-colors">
                  <span className="text-sm sm:text-base font-medium">Start here</span>
                  <ChevronRight className="ml-2 h-4 w-4 sm:h-5 sm:w-5" />
                </div>
              </div>
            </Link>
