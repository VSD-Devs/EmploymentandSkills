    ...
    <div className="bg-white">
      ...
      >
        ...
        <div className="md:block pb-20 md:pb-0"> {/* Add padding bottom for mobile nav */}
          ...
          <div id="collegesAndProviders" className="relative scroll-mt-20 overflow-hidden">
            ...
            <div className="relative py-32">
              <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
                <div className="grid md:grid-cols-2 gap-16 lg:gap-20 items-center">
                  ...
                  <div>
                    <div className="inline-flex items-center gap-3 px-5 py-3 rounded-full bg-white shadow-md border-blue-300 mb-8">
          ...
          {/* Schools Section */}
          <div id="schools" className="relative scroll-mt-20 overflow-hidden">
            ...
            <div className="relative py-32">
              <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
                <div className="grid md:grid-cols-2 gap-16 lg:gap-20 items-center">
                  <div>
                    <div className="inline-flex items-center gap-3 px-5 py-3 rounded-full bg-white shadow-md border-emerald-300 mb-8">
