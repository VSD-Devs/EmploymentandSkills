...
const ApprenticeshipPage = () => {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="relative bg-[#111827] py-20 sm:py-32 min-h-[500px] sm:min-h-[600px] flex items-center">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center md:text-left md:max-w-3xl">
            <div className="inline-flex items-center gap-2 text-emerald-300 mb-4 sm:mb-6">
              <div className="p-2 rounded-lg bg-emerald-500/20 backdrop-blur-sm border border-emerald-400/30">
                <GraduationCap className="h-4 w-4 sm:h-5 sm:w-5" />
              </div>
              <span className="text-sm sm:text-base font-medium tracking-wide uppercase">South Yorkshire Apprenticeships</span>
            </div>
            ...
            <p className="text-base sm:text-xl text-gray-200 max-w-2xl mb-6 sm:mb-8 leading-relaxed">
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-3 sm:gap-5 mt-6 sm:mt-8">
              <a
                href="https://www.instituteforapprenticeships.org/apprenticeship-standards/"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center px-5 py-3 sm:px-8 sm:py-4 rounded-lg bg-emerald-600 text-white text-base sm:text-lg font-medium hover:bg-emerald-500 transition-colors shadow-lg hover:shadow-xl hover:shadow-emerald-500/20 transition-all"
              >
                Browse Standards
              ...
              <Link
                ...
                className="inline-flex items-center px-5 py-3 sm:px-8 sm:py-4 rounded-lg bg-white/15 backdrop-blur-sm text-white text-base sm:text-lg font-medium hover:bg-white/25 transition-colors border border-white/20 shadow-lg"
              >
                View Vacancies
      ...
      <div className="relative -mt-8 sm:-mt-16 mb-8 sm:mb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            <div className="bg-white rounded-xl p-6 sm:p-8 shadow-xl border border-gray-100 hover:shadow-2xl transition-shadow">
              <div className="flex items-center gap-4 sm:gap-5">
                <div className="p-3 sm:p-4 rounded-xl bg-emerald-100">
                ...
                <div>
                  ...
                  <p className="text-base sm:text-xl text-gray-600">Off-the-job Training</p>
                </div>
              </div>
              <p className="mt-4 text-base sm:text-lg text-gray-500 leading-relaxed">Dedicated time for learning and development during work hours, ensuring you build valuable skills alongside practical experience</p>
            </div>
            <div className="bg-white rounded-xl p-6 sm:p-8 shadow-xl border border-gray-100 hover:shadow-2xl transition-shadow">
              <div className="flex items-center gap-4 sm:gap-5">
                <div className="p-3 sm:p-4 rounded-xl bg-emerald-100">
                ...
                <div>
                  <p className="text-2xl sm:text-3xl font-bold text-gray-900">12-48</p>
                  <p className="text-base sm:text-xl text-gray-600">Months Duration</p>
                </div>
              </div>
              <p className="mt-4 text-base sm:text-lg text-gray-500 leading-relaxed">Depending on the level and sector of your apprenticeship, with structured progression and clear career development paths</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white py-16 sm:py-20 md:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 sm:mb-16">
            <h2 className="relative text-3xl sm:text-4xl font-bold text-gray-900 mb-4 sm:mb-6 inline-block">
          ...
          <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-start">
            <div className="space-y-8 sm:space-y-10">
              ...
              <div className="space-y-6 sm:space-y-8">
                <div className="bg-gray-50 rounded-xl p-6 sm:p-8 hover:shadow-lg transition-shadow border border-gray-100">
                  <div className="flex gap-4 sm:gap-6">
                    <div className="w-12 h-12 sm:w-16 sm:h-16 bg-emerald-100 rounded-xl flex items-center justify-center flex-shrink-0">
                      <Briefcase className="h-6 w-6 sm:h-8 sm:w-8 text-emerald-600" />
                    </div>
                    <div>
                      <h3 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-2 sm:mb-3">Work Experience</h3>
                ...
                <div className="bg-gray-50 rounded-xl p-6 sm:p-8 hover:shadow-lg transition-shadow border border-gray-100">
                  <div className="flex gap-4 sm:gap-6">
                    ...
                    <div>
                      <h3 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-2 sm:mb-3">Study Programme</h3>
                      <p className="text-base sm:text-lg text-gray-600 leading-relaxed">
                ...
                <div className="bg-gray-50 rounded-xl p-6 sm:p-8 hover:shadow-lg transition-shadow border border-gray-100">
                  <div className="flex gap-4 sm:gap-6">
                    ...
                    <div>
                      <h3 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-2 sm:mb-3">Recognised Qualification</h3>
                      <p className="text-base sm:text-lg text-gray-600 leading-relaxed">
              ...
              <div className="bg-emerald-50 rounded-xl p-6 sm:p-8 border border-emerald-100 shadow-lg">
                <h4 className="font-semibold text-emerald-900 mb-4 sm:mb-6 flex items-center gap-3 text-lg sm:text-xl">
                  <GraduationCap className="h-5 w-5 sm:h-6 sm:w-6 text-emerald-600" />
                  Available Qualification Levels
                </h4>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                  <div className="bg-white rounded-lg p-4 sm:p-6 border border-emerald-100 hover:shadow-md transition-shadow">
                    <span className="text-xl sm:text-2xl font-bold text-emerald-600">Level 2-3</span>
                    <p className="text-sm sm:text-base text-emerald-700 mt-2">GCSE to A-level equivalent</p>
                  </div>
                  <div className="bg-white rounded-lg p-4 sm:p-6 border border-emerald-100 hover:shadow-md transition-shadow">
                    <span className="text-xl sm:text-2xl font-bold text-emerald-600">Level 4-5</span>
                    <p className="text-sm sm:text-base text-emerald-700 mt-2">Foundation degree equivalent</p>
                  </div>
                  <div className="bg-white rounded-lg p-4 sm:p-6 border border-emerald-100 hover:shadow-md transition-shadow">
                    <span className="text-xl sm:text-2xl font-bold text-emerald-600">Level 6</span>
                    <p className="text-sm sm:text-base text-emerald-700 mt-2">Bachelor's degree equivalent</p>
                  </div>
                  <div className="bg-white rounded-lg p-4 sm:p-6 border border-emerald-100 hover:shadow-md transition-shadow">
                    <span className="text-xl sm:text-2xl font-bold text-emerald-600">Level 7</span>
                    <p className="text-sm sm:text-base text-emerald-700 mt-2">Master's degree equivalent</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Mobile-only image */}
            <div className="md:hidden relative mt-8 mb-6">
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-white/95 backdrop-blur-sm rounded-b-2xl shadow-lg p-4 border-t border-gray-200">
                <div className="flex items-center gap-3">
                  <Users className="h-8 w-8 text-emerald-600" />
                  <div>
                    <h4 className="font-semibold text-gray-900 text-lg">Support Network</h4>
                    <p className="text-sm text-gray-600">Dedicated mentors throughout your journey</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="bg-gray-50 py-16 sm:py-20 md:py-28 border-y border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3 text-emerald-600 mb-4 sm:mb-6">
            ...
            <span className="text-base sm:text-lg font-medium tracking-wide uppercase">Your Local Support</span>
          </div>
          
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6 max-w-2xl">
            South Yorkshire Apprenticeship Hub
          </h2>

          <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
            <div>
              <p className="text-xl sm:text-2xl leading-relaxed text-gray-600 mb-6 sm:mb-8">
                We're here to help you navigate your apprenticeship journey. Our dedicated team provides:
              </p>
              <div className="space-y-4 sm:space-y-6">
                <div className="bg-white rounded-xl p-5 sm:p-6 hover:shadow-lg transition-shadow border border-gray-100">
                  <div className="flex gap-4 sm:gap-5">
                    ...
                    <div>
                      <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2">One-to-one support and guidance</h3>
                      <p className="text-base sm:text-lg text-gray-600">Personalised advice to help you find and secure the right opportunity</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl p-5 sm:p-6 hover:shadow-lg transition-shadow border border-gray-100">
                  <div className="flex gap-4 sm:gap-5">
                    ...
                    <div>
                      <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2">Help finding the right apprenticeship</h3>
                      <p className="text-base sm:text-lg text-gray-600">Matching your skills and interests with the perfect opportunity</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl p-5 sm:p-6 hover:shadow-lg transition-shadow border border-gray-100">
                  <div className="flex gap-4 sm:gap-5">
                    ...
                    <div>
                      <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2">Application and interview preparation</h3>
                      <p className="text-base sm:text-lg text-gray-600">Expert coaching to help you stand out to potential employers</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl p-5 sm:p-6 hover:shadow-lg transition-shadow border border-gray-100">
                  <div className="flex gap-4 sm:gap-5">
                    ...
                    <div>
                      <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2">Connections with local employers</h3>
                      <p className="text-base sm:text-lg text-gray-600">Direct links to businesses looking for apprentices like you</p>
                    </div>
                  </div>
                </div>
              </div>
              <div className="mt-8 sm:mt-10">
                <Link
                  href="/contact"
                  className="inline-flex items-center px-6 py-3 sm:px-8 sm:py-4 rounded-lg bg-emerald-600 text-white text-base sm:text-lg font-medium hover:bg-emerald-500 transition-colors shadow-lg hover:shadow-xl hover:shadow-emerald-500/20 transition-all"
                >
                  Get Support
            ...
            <div className="relative h-[400px] sm:h-[500px] md:h-[600px] rounded-2xl overflow-hidden shadow-2xl order-first md:order-last mb-8 md:mb-0">
              <Image
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8 bg-gradient-to-t from-black/80 to-transparent">
                <p className="text-white text-lg sm:text-xl font-medium">Our team is ready to support your apprenticeship journey</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 sm:mb-16">
            ...
            <div className="flex items-center justify-center gap-2 text-emerald-600 mb-4 sm:mb-6">
              <span className="text-base sm:text-lg font-medium tracking-wide uppercase">How It Works</span>
            </div>
          ...
          <div className="mt-10 sm:mt-16">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-10 items-stretch">
              ...
              <div key={index} className="bg-white rounded-xl shadow-xl overflow-hidden border border-gray-100 hover:shadow-2xl transition-all group">
                <div className="relative h-52 sm:h-64 w-full">
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <span className="inline-flex items-center justify-center w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-emerald-500 text-white font-bold text-base sm:text-lg">{index + 1}</span>
                  </div>
                </div>
                <div className="p-5 sm:p-8">
                  <div className="w-12 h-12 sm:w-16 sm:h-16 bg-emerald-100 rounded-xl flex items-center justify-center mb-4 sm:mb-6 group-hover:bg-emerald-200 transition-colors">
                    <step.icon className="h-6 w-6 sm:h-8 sm:w-8 text-emerald-600" />
                  </div>
      ...
      {/* Current Vacancies Section - UPDATED FOR ACCESSIBILITY & MOBILE */}
      <div id="current-vacancies" className="bg-gradient-to-b from-gray-50 to-white py-16 sm:py-20 md:py-28 border-y border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 sm:mb-16">
            <h2 className="relative text-3xl sm:text-4xl font-bold text-gray-900 mb-4 sm:mb-6 inline-block">
          ...
          <div className="text-center mb-8 sm:mb-12">
            <div className="flex items-center justify-center gap-3 text-emerald-600 mb-4 sm:mb-6">
              <span className="inline-block w-3 h-3 rounded-full bg-emerald-600" />
              <span className="text-base sm:text-lg font-medium tracking-wide uppercase">Latest Opportunities</span>
            </div>
            <p className="text-base sm:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
          ...
          {isLoading && (
            <div className="text-center py-10 sm:py-16">
              <div className="animate-spin rounded-full h-12 w-12 sm:h-16 sm:w-16 border-b-2 border-emerald-600 mx-auto mb-4 sm:mb-6"></div>
              <p className="text-lg sm:text-xl text-gray-600">Loading apprenticeships...</p>
            </div>
          )}

          {/* Error State */}
          {error && (
            <div className="text-center py-10 sm:py-16 bg-red-50 rounded-xl border border-red-100 shadow-md">
              <p className="text-lg sm:text-xl text-red-600 font-medium">{error}</p>
              <button 
                onClick={() => window.location.reload()} 
                className="mt-6 px-5 py-2 sm:px-6 sm:py-3 bg-red-600 text-white rounded-lg hover:bg-red-500 transition-colors"
              >
                Try Again
              </button>
            </div>
          ...
          {/* Vacancies Grid - UPDATED FOR ACCESSIBILITY & MOBILE */}
          {!isLoading && !error && (
            <div className="space-y-6 sm:space-y-8">
                    ...
                    <div className="p-5 sm:p-6">
                      <div className="mb-4">
                        <div className="flex items-center gap-2 text-emerald-700 mb-2 sm:mb-3">
                          <GraduationCap className="h-4 w-4 sm:h-5 sm:w-5" />
                          <span className="text-sm sm:text-base font-medium">{vacancy.apprenticeshipLevel}</span>
                        </div>
                        <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 sm:mb-3 leading-tight">
                          {vacancy.title}
                        </h3>
                        <p className="text-sm sm:text-base text-gray-700 line-clamp-3 mb-3 sm:mb-4 leading-relaxed">
                          {vacancy.description}
                        </p>
                      </div>
                      ...
                      <div className="space-y-2 sm:space-y-3 border-t border-gray-100 pt-3 sm:pt-4 mb-3 sm:mb-4">
                        <div className="flex items-center gap-2 text-gray-700">
                          <Building2 className="h-4 w-4 sm:h-5 sm:w-5 text-emerald-700 flex-shrink-0" />
                          <span className="line-clamp-1 text-sm sm:text-base">{vacancy.employerName}</span>
                        </div>
                        <div className="flex items-center gap-2 text-gray-700">
                      ...
                      <div className="flex items-center justify-between pt-3 sm:pt-4 border-t border-gray-100">
                        <span className="text-emerald-700 font-medium text-sm sm:text-base line-clamp-1">
                          {(() => {
                        ...
                        <Link
                          ...
                          className="inline-flex items-center px-3 py-1.5 sm:px-4 sm:py-2 bg-emerald-700 text-white rounded-lg hover:bg-emerald-600 transition-colors text-sm sm:text-base"
                        >
                          View Details
              ...
              <div className="text-center mt-10 sm:mt-16">
                <Link
                  href="/apprenticeships/vacancies"
                  className="inline-flex items-center px-6 py-3 sm:px-8 sm:py-4 bg-emerald-700 text-white rounded-xl hover:bg-emerald-600 transition-colors text-base sm:text-lg"
                >
                  View All Vacancies
                  <ArrowRight className="ml-2 h-4 w-4 sm:h-5 sm:w-5" />
                </Link>
          ...
          {!isLoading && !error && filteredVacancies.length === 0 && (
            <div className="text-center py-10 sm:py-16 bg-white rounded-xl shadow-lg border border-gray-200">
              <div className="mb-4 sm:mb-6">
                <Search className="h-12 w-12 sm:h-16 sm:w-16 text-gray-400 mx-auto" />
              </div>
              <p className="text-xl sm:text-2xl text-gray-900 font-medium mb-3 sm:mb-4">
                No apprenticeships found
              </p>
              <p className="text-base sm:text-xl text-gray-700 max-w-2xl mx-auto mb-6 sm:mb-8">
                Try adjusting your search criteria or browse all opportunities
              </p>
              <button
                onClick={() => setSearchTerm('')}
                className="px-5 py-2.5 sm:px-6 sm:py-3 bg-emerald-700 text-white rounded-lg hover:bg-emerald-600 transition-colors text-base sm:text-lg"
              >
                Clear Search
              </button>
            </div>
      ...
      <div className="bg-white py-16 sm:py-20 md:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 sm:mb-16">
            ...
            <div className="flex items-center justify-center gap-3 text-emerald-600 mb-4 sm:mb-6">
              <span className="text-base sm:text-lg font-medium tracking-wide uppercase">Local Success Stories</span>
            </div>
            <p className="text-base sm:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              ...
              <div key={story.id} className="bg-gray-50 rounded-xl overflow-hidden shadow-xl hover:shadow-2xl transition-all group">
                <div className="relative h-64 sm:h-80">
                  ...
                  <div className="absolute bottom-6 left-6 right-6">
                    <h3 className="text-xl sm:text-2xl font-bold text-white mb-1 sm:mb-2">{story.name}</h3>
                    <p className="text-base sm:text-lg text-white/90">{story.role}</p>
                    <p className="text-sm sm:text-base text-white/80">{story.company}</p>
                  </div>
                </div>
                <div className="p-6 sm:p-8">
                  <Quote className="h-8 w-8 sm:h-10 sm:w-10 text-emerald-600 mb-4 sm:mb-6 opacity-50" />
                  <p className="text-base sm:text-xl text-gray-600 italic leading-relaxed">
                    {story.quote}
                  </p>
                </div>
              </div>
      ...
      <div className="bg-gray-50 py-16 sm:py-20 md:py-28 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 sm:mb-16">
            <div className="flex items-center justify-center gap-3 text-emerald-600 mb-4 sm:mb-6">
              <span className="inline-block w-3 h-3 rounded-full bg-emerald-600" />
              <span className="text-base sm:text-lg font-medium tracking-wide uppercase">Apprenticeship Life</span>
            </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 sm:gap-6">
            {[1, 2, 3, 4, 5, 6, 7, 8].map((index) => (
              <div key={index} className="relative aspect-square rounded-lg sm:rounded-xl overflow-hidden group shadow-md sm:shadow-lg hover:shadow-xl transition-all">
                <Image
