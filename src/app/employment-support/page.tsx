    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="relative bg-[#111827] py-20 min-h-[480px] flex items-center">
        <div className="absolute inset-0">
          <Image
            src={IMAGES.hero}
            alt="Employment support and career development services in South Yorkshire"
            fill
          ...
          <div className="max-w-3xl mx-auto">
            <div className="text-center">
              ...
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 mb-6">
                ...
                <span className="text-sm font-medium text-blue-100">Career Development Support</span>
              </div>

              {/* Main Content */}
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6">
                Your Journey to Career<br className="hidden sm:block" /> Success Starts Here
              </h1>
              ...
              <div className="mt-12 grid grid-cols-3 gap-4 max-w-2xl mx-auto">
                {[
                  ...
                  { number: "6m", label: "Duration of Support", icon: Clock }
                ].map((stat, index) => (
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-100/50 border border-blue-200 mb-6">
              ...
              <span className="text-sm font-medium text-blue-900">Our Programmes</span>
            </div>
            <h2 className="text-2xl md:text-4xl font-bold text-gray-900 mb-4">How We Support You</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">Choose from our specialist programmes designed to support your journey to employment and wellbeing.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="group relative bg-white rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-200">
                {/* Programme Image */}
                <div className="relative h-48 w-full overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <div className="flex items-center gap-2 text-white">
                      <div className="w-8 h-8 rounded-full bg-blue-600/20 backdrop-blur-sm flex items-center justify-center">
                        <programme.icon className="h-4 w-4 text-white" />
                      </div>
                      <h3 className="font-semibold text-lg">{programme.title}</h3>
                    </div>
                  </div>
                </div>
      ...
      <div id="eligibility" className="relative py-12 md:py-24 bg-gray-50 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 md:mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-100/50 border border-blue-200 mb-4">
              <Sparkles className="h-5 w-5 text-blue-600" />
              <span className="text-sm font-medium text-blue-900">Eligibility Criteria</span>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="group relative">
              <div className="absolute inset-0 bg-gradient-to-r from-blue-100/50 to-blue-200/30 rounded-2xl transform group-hover:scale-[1.02] transition-transform duration-300" />
              <div className="relative bg-white rounded-xl p-6 md:p-8 shadow-sm border border-blue-100">
            ...
            <div className="group relative">
              <div className="absolute inset-0 bg-gradient-to-r from-blue-200/30 to-blue-100/50 rounded-2xl transform group-hover:scale-[1.02] transition-transform duration-300" />
              <div className="relative bg-white rounded-xl p-8 shadow-sm border border-blue-100">
      ...
      <div 
        id="apply" 
        className="relative bg-white md:bg-gradient-to-b md:from-white md:via-blue-50/30 md:to-white"
      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/80 border border-blue-200 mb-6 backdrop-blur-sm">
            ...
            <p className="text-gray-700">Complete the form below to begin your application for employment support.</p>
          </div>
                ...
                return (
                  <div key={index} className="flex flex-col items-center relative z-10">
                    <div className={`flex items-center justify-center w-12 h-12 rounded-full border-2 mb-2 transition-all duration-300 bg-white
                      ${formStep > index + 1 ? 'border-blue-600 bg-blue-600' : 
                        formStep === index + 1 ? 'border-blue-600' : 
                        'border-gray-300'}`}>
                      <StepIcon className={`w-6 h-6 transition-colors duration-300 ${
                        formStep > index + 1 ? 'text-white' : 
                        formStep === index + 1 ? 'text-blue-600' : 
                        'text-gray-400'
                      }`} />
                    </div>
                    <span className={`text-sm font-medium transition-colors duration-300 ${
                      formStep >= index + 1 ? 'text-blue-600' : 'text-gray-500'
                    }`}>
                      {step.title}
                    </span>
                  </div>
                    ...
                    <div className="relative">
                      {field === 'currentStatus' ? (
                        <select
                          ...
                          className="w-full px-4 py-3 rounded-xl bg-white border-2 border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 text-lg transition-colors hover:border-gray-300"
                          required
                        >
                          <option value="">Select current status</option>
                          <option value="employedStruggling">Employed but struggling with health condition</option>
                          <option value="recentlyUnemployed">Recently unemployed due to health</option>
                          <option value="lookingForWork">Looking for work with complex barriers</option>
                          <option value="other">Other</option>
                        </select>
                      ) : field === 'preferredProgramme' ? (
                        <select
                          id={field}
                          name={field}
                          value={formData[field]}
                        ...
                        >
                          ...
                          <option value="connectToWork">Connect to Work</option>
                          <option value="workWell">WorkWell</option>
                        ...
                        >
                          ...
                          <option value="selfReferral">Self-referral</option>
                          <option value="other">Other</option>
                        </select>
                        ...
                        <select
                          ...
                          required
                        >
                          <option value="">Select health condition type</option>
                          <option value="physical">Physical health condition</option>
                          <option value="mental">Mental health condition</option>
                          <option value="both">Both physical and mental health</option>
                          <option value="other">Other disability or condition</option>
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 pt-8 border-t border-gray-200">
                  {formStep > 1 && (
                    <button
                      ...
                      className="w-full sm:w-auto inline-flex items-center justify-center px-6 py-3 text-blue-600 hover:text-blue-500 border-2 border-blue-200 hover:border-blue-300 rounded-xl transition-colors"
                    >
                  ...
                  {formStep < formSteps.length ? (
                    <button
                      ...
                      className="w-full sm:w-auto inline-flex items-center justify-center px-6 py-3 bg-blue-600 text-white rounded-xl hover:bg-blue-500 transition-colors"
                    >
                      Next Step
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              <div key={index} className="group relative">
                <div className="absolute inset-0 bg-gradient-to-r from-blue-900/20 to-blue-800/20 rounded-xl transform group-hover:scale-[1.02] transition-transform duration-300" />
                ...
                <div className="grid gap-4">
                  {questions[currentQuestion].options.map((option) => (
                    <button
                      ...
                      className="w-full px-6 py-4 text-left text-lg font-medium rounded-xl border-2 border-blue-100 hover:border-blue-500 hover:bg-blue-50 transition-colors"
                    >
                      {option}
                    </button>
                  ))}
